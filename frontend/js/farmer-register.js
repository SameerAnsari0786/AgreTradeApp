...
const REGISTER_ENDPOINT = '/api/farmers/register';
...
async function registerFarmer(formData) {
    try {
        ...
        if (response.ok) {
            ...
            showAlert('Farmer registration successful! 🎉 Redirecting to login...', 'success');
            form.reset();
...
window.addEventListener('DOMContentLoaded', () => {
    ...
    console.log('Farmer registration page loaded');
});
